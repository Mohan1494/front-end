    ...
    <div className="home">
      ...
      <section className="model-results-section">
        ...
        <div className="model-results">
          ...
          <div className="model-result right">
            ...
            <p>Accuracy: 0.8189</p> {/* Replace with your actual accuracy value */}
            <img src={bertModelImage} alt="BERT Model Accuracy" style={{ maxWidth: '300px', maxHeight: '200px' }}/>
          </div>
        </div>
      </section>
      ...
      <section className="challenges-section">
        ...
        <ul>
          ...
          <li>Model Performance: Despite improved accuracy with BERT, challenges remain in handling the linguistic nuances and complexities of Tamil text.</li>
        </ul>
      </section>
